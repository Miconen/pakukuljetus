    ...
    return (
        <div className="flex justify-center py-32">
            <Container className="gap-8 items-center">
                <h2 className="font-extrabold text-4xl">Hinnat</h2>
                <p className="text-xl">Tarjoamme muutot Helsingin alueella edullisesti alkaen 240 € / 2 tuntia.</p>
                <div className="flex gap-8 flex-col md:flex-row lg:w-1/2">
                    <div className="bg-white text-white flex flex-col p-8 gap-8 rounded-md bg-orange-500">
                ...
                <p className="text-center w-1/2">Maksu tapahtuu muuton päätteeksi pankkikortilla, luottokortilla tai käteisellä.
